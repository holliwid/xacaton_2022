...
class QImageViewer(QMainWindow):
    ...
    def CreateUI(self):
        ...
        self.TXTButton.setText(_translate("Form", "TXT"))
        self.TXTButton.clicked.connect(self.GetTXT)
        self.TXTButton.move(0,60)
    ...
    def GetTXT(self):
        ...
        for i in range(len(next(os.walk(f"runs/track/example{mainFolderID}"))[1])):
            if i == 0 or i == 1:
                txtList.append(f"runs/track/example{mainFolderID}/exp/tracks"+os.listdir(f"runs/track/example{mainFolderID}/exp/tracks")[0])
            else:
                txtList.append(f"runs/track/example{mainFolderID}/ex{i}/tracks"+os.listdir(f"runs/track/example{mainFolderID}/exp{i}/tracks")[0])
        for i in txtList:
            print(i)
